...
public class GroupAdp extends RecyclerView.Adapter<GroupAdp.ViewHolder> {
    private Activity activity;ArrayList<String> arrayListGroup;
    public GroupAdp(Activity activity, ArrayList<String> arrayListGroup) {
        this.activity = activity;
        this.arrayListGroup = arrayListGroup; }@NonNull @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.list_row_group,parent,false);
        return new GroupAdp.ViewHolder(view); }@Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.textView.setText(arrayListGroup.get(position));
...
MemberAdp adapterMember = new MemberAdp(arrayListMember);
        ...
        holder.recyclerView.setAdapter(adapterMember); }@Override
    public int getItemCount() {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            recyclerView=itemView.findViewById(R.id.rev2); }}}
